...
.. code-block:: bash
    ...
    # replace "forecast_plot_input.json" with the path to your input json
    python -m cuwalid.forecasting.Main_plot forecast_plot_input.json

Or you can import the function into your code like this:

.. code-block:: python

    from cuwalid.forecasting.Main_plot import plot_maps_json

    # replace "forecast_plot_input.json" with the path to your input json
    plot_maps_json("forecast_plot_input.json")
...
.. code-block:: python
    ...
    from cuwalid.forecasting.Main_plot import call_plot_maps
