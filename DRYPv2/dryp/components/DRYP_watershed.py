...
#from components.DRYP_io_files import get_model_settings
from DRYPv2.dryp.components.DRYP_io import (
	grid_environment,
...
def get_watershed_area(fname_surface, fname_outlet, fname_out=None,
	...
	>>> from DRYPv2.dryp.components.DRYP_watershed import get_watershed_map
