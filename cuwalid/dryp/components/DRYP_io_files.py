...
class get_model_settings(object):
	...
	def __init__(self, filename_inputs, first_read=1):
		...
		# Datasets format
		self.data_reading['pre'] = int(netcdf_opt[0])
		self.netcf_ETo = int(netcdf_opt[1])
		self.data_reading['abs'] = int(netcdf_opt[2])
		self.netcf_kc =  int(netcdf_opt[3])
		self.netcf_Flux =int(netcdf_opt[4])
		self.netcf_savi =int(netcdf_opt[5])
		self.data_reading['savi_min'] =int(netcdf_opt[6])
		self.data_reading['savi_max'] =int(netcdf_opt[7])
		
		# Dataset time step
		self.data_step['pre'] = int(time_step[0])
		self.data_step['pet'] = int(time_step[1])
		self.data_step['abs'] = int(time_step[2])
		self.data_step['kc'] =  int(time_step[3])
		self.data_step['flux'] =int(time_step[4])
		self.data_step['savi'] =int(time_step[5])
		self.data_step['savi_min'] = int(time_step[6])
		self.data_step['savi_max'] = int(time_step[7])
		
		# Datasets reprojection
		self.data_reproject['pre'] = int(reproj_opt[0])
		self.data_reproject['pet'] = int(reproj_opt[1])
		self.data_reproject['abs'] = int(reproj_opt[2])
		self.data_reproject['kc'] =  int(reproj_opt[3])
		self.reproject_Flux =int(reproj_opt[4])
		self.data_reproject['savi'] =int(reproj_opt[5])
		self.data_reproject['savi_min'] = int(reproj_opt[6])
		self.data_reproject['savi_max'] = int(reproj_opt[7])
		
		# Datasets interpolate
		self.data_interpolate['pre']['pre'] = int(interp_opt[0])
		self.data_interpolate['pet'] = int(interp_opt[1])
		self.data_interpolate['abs'] = int(interp_opt[2])
		self.data_interpolate['kc'] =  int(interp_opt[3])
		self.data_interpolate['flux'] =int(interp_opt[4])	
		self.data_interpolate['savi'] =int(interp_opt[5])
		self.data_interpolate['savi_min'] = int(interp_opt[6])
		self.data_interpolate['savi_max'] = int(interp_opt[7])
